...
- **Back and Forward** (the **←** / **→** toolbar buttons, or **Alt+Left** / **Alt+Right**) walk the documents you have read — following everything you looked at, arrow-key browsing included. Each greys out when there is nowhere to go that way, a document deleted or moved since you saw it is skipped rather than stopping you, and opening something new drops the forward trail as a browser does.
